...
<span class="statement">let</span> <span class="variable">htmlWebpackPlugin</span> = <span class="object">new</span> <span class="function">HtmlWebpackPlugin</span>({
    ...
    <span class="code_notes">// 虚拟html的模板为 src下的index.html</span>
...
<span class="object">module</span>.<span class="object">exports</span> = {
    ...
    output: {
        path: <span class="variable">path</span>.<span class="function">resolve</span>(__dirname, 'dist'),
    ...
    devServer: {
      ...
      contentBase: <span class="variable">path</span>.<span class="function">join</span>(__dirname, 'dist'),
    ...
    resolve: {
      ...
      alias: {
        ...
        <span class="string">'@'</span>: <span class="variable">path</span>.<span class="function">join</span>(<span class="string">'src'</span>),
      }
    },
